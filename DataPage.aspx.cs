...
namespace DataTable_Project
{
    public partial class DataPage : System.Web.UI.Page
    {
        ...
        public DataPage()
        {
            sqlConnection = new SqlConnection("Data Source=DESKTOP-251;Initial Catalog=myDB;Integrated Security=True");
        }
        ...
        public  bool UserIden()
        {
            var nm = Session["User"].ToString();
            if (Session["User"].ToString()== "Admin")
            {
                return true;
        ...
        public class Accountants 
        {
            ...
            public List<Accountants> RetList()
            {
                ...
                string conString = "Data Source=DESKTOP-251;Initial Catalog=myDB;Integrated Security=True";
        ...
        public class Customers 
        {
            ...
            public List<Customers> RetAcc()
            {
                ...
                while (rdr.Read())
                {
                    ...
                    cust.Adress = rdr["Address"].ToString();
                    newList.Add(cust);
                }
                return newList;
            }
        ...
        public static string GetAccountants()
        {
            ...
            return serializer.Serialize(accList);
        ...
        [WebMethod]
        public static bool UpdateAcc(string Name, string Email, string Password, string ID)
        {
            //string conString = "Data Source=CMDLHRDB01;Initial Catalog=MyDB;User ID=sa;Password=CureMD2022";
            string conString = "Data Source=DESKTOP-251;Initial Catalog=myDB;Integrated Security=True";
            ...
            string qeury = "update accList set userName='" + Name + "', Email='" + Email + "', Password='" + Password + "'  where ID='" + ID + "'";
            SqlCommand cmd = new SqlCommand(qeury, con);
            con.Open();
            cmd.ExecuteNonQuery();
            return true;
        ...
        public static bool DelCust(int ID)
        {
            ...
            string qeury = "delete from customersList where  ID='" + ID + "'";
            SqlCommand cmd = new SqlCommand(qeury, con);
            con.Open();
            cmd.ExecuteNonQuery();
            return true;
        }
        public static SqlConnection RetCon()
        {
            string conString = "Data Source=DESKTOP-251;Initial Catalog=myDB;Integrated Security=True";
